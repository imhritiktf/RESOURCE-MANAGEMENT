...
const { createRequest, getRequests, getFacultyRequests, updateRequestStatus,getSuspiciousRequests, deleteRequest, getRequestLog, getRequestLogByRequestId, getSlaBreachedRequests } = require("../controllers/requestController");
const { protect, isSupervisorOrTrustee, isTrustee } = require("../middleware/authMiddleware");
...
router.get("/logs/:requestId", protect, isSupervisorOrTrustee, getRequestLogByRequestId);
